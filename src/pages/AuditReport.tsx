...
import { Shield, CheckCircle, AlertTriangle, FileText, Download, ExternalLink, Calendar, Users } from "lucide-react";
  ...
  const auditFindings = [
    {
      ...
      description: "Some functions could be optimized for lower gas consumption",
      status: "Resolved",
      color: "bg-yellow-500"
    },
    {
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12 px-4">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto">
            Comprehensive security audit results for NORAH Token smart contracts across all supported networks.
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <Badge variant="outline" className="bg-green-500/10 text-green-500 border-green-500">0</Badge>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <Badge variant="outline" className="bg-yellow-500/10 text-yellow-500 border-yellow-500">2</Badge>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Low Risk:</span>
                  <Badge variant="outline" className="bg-blue-500/10 text-blue-500 border-blue-500">1</Badge>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-card border-border shadow-card">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Senior Analyst:</span>
                  <span className="text-sm font-semibold">Michael Torres</span>
                </div>
                <div className="flex justify-between">
                ...
                <div key={index} className="p-4 rounded-lg bg-muted/20 border border-border">
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <Badge className={`${finding.color} text-white`}>{finding.severity}</Badge>
            ...
            <CardContent>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm">All critical and high-risk issues have been resolved</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 mt-1" />
                  <span className="text-sm">Regular security monitoring recommended</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 mt-1" />
                  <span className="text-sm">Annual re-audit schedule established</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 mt-1" />
                  <span className="text-sm">Multi-signature implementation verified</span>
                </li>
              </ul>
            </CardContent>
          </Card>
