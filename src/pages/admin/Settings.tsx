    ...
    <AdminLayout>
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">Configure your presale parameters</p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSettings({ ...settings, raised_amount: e.target.value })
                    }
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSettings({ ...settings, participants_count: e.target.value })
                    }
                    required
                  />
                </div>
