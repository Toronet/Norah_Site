...
import { Copy, Check, ExternalLink, Shield, FileText, Code, Users, TrendingUp } from "lucide-react";
  ...
  const contractFeatures = [
    {
      ...
      description: "Contract requires multiple signatures for critical operations"
    },
    {
      icon: FileText,
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12 px-4">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto">
            NORAH Token smart contract details, addresses, and verification information across all supported networks.
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-muted/20 border border-border">
                  <div className="text-2xl font-bold text-primary">ERC-20</div>
                  <div className="text-sm text-muted-foreground">Ethereum Standard</div>
                </div>
                <div className="p-4 rounded-lg bg-muted/20 border border-border">
                  <div className="text-2xl font-bold text-primary">BEP-20</div>
                  <div className="text-sm text-muted-foreground">BSC Standard</div>
                </div>
                <div className="p-4 rounded-lg bg-muted/20 border border-border">
                  <div className="text-2xl font-bold text-primary">SPL</div>
                  <div className="text-sm text-muted-foreground">Solana Standard</div>
                </div>
                <div className="p-4 rounded-lg bg-muted/20 border border-border">
                  <div className="text-2xl font-bold text-primary">TRC-20</div>
                  <div className="text-sm text-muted-foreground">Tron Standard</div>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-muted/20 border border-border">
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {Object.entries(contractAddresses).map(([network, address]) => (
                <div key={network} className="p-4 rounded-lg bg-muted/20 border border-border">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      window.open(explorerUrls[network as keyof typeof explorerUrls], '_blank');
                    }}
                  >
