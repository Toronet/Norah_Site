              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-muted/20 p-4 rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    <strong>Note:</strong> Some information may be retained for longer periods for legal, regulatory, or business purposes, such as transaction records required for compliance with anti-money laundering regulations.
                  </p>
                </div>
              </CardContent>
            </Card>
